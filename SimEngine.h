 ...
 * @brief Data container that holds all necessary information for one singular trade, used in vector of structs to compile whole trading record of simulation
 */
struct TradingRecord {
